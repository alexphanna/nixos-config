{ pkgs, ... }:
{
  programs.mpv = {
    ...
    bindings = {
      ...
      "CTRL+7" = ''no-osd change-list glsl-shaders set "${./NVScaler.glsl}"; show-text "NVIDIA Image Scaling"'';
      "CTRL+8" = ''no-osd change-list glsl-shaders set "${./FSR.glsl}"; show-text "FidelityFX FSR"'';
